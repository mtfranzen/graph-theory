			...
			\begin{itemize}
				...
				\item [$\mathbf{n \geq 2}$]
					...
					\item[$\mathbf{n \leq k \leq 2n}$]:
						...
						Because removing one vertex can not increase the number of components by more than one and $V'=2n-k\leq n \leq k$, there can not  be more than k odd components.
