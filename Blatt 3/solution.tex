		...
		\begin{theorem}{The Petersen graph is not hamiltonian, it has a girth of $5$, a diameter of $2$, an order of $10$ and a size of $15$.}
			...
			\begin{itemize}
				...
				\item \emph{$(v_1,v_6)$ is an edge of Peterson Graph}\\
					...
					\end{center}
			\end{itemize}
			Because of the symmetry of the cycle we can conclude that there is no way to construct the Peterson graph from a cycle with 10 vertices.
			Thus, we know that the Peterson graph cannot be Hammiltonian. 
		\end{theorem}
	\end{solution}
	\newpage
	\begin{solution}{11}
